...
**🚀 [Live Demo](https://gas-fee-estimator.vercel.app)**

Multi-chain gas prediction engine using historical data and mempool analysis. Features EIP-1559 base fee forecasting, priority fee optimization, gas spike detection, and L2 comparison.
...
git clone https://github.com/nasrulniroi/gas-fee-estimator.git
...
# Set up database
psql -c "CREATE DATABASE gas_fee_estimator"
psql gas_fee_estimator < database/001_initial.sql
...
```env
DATABASE_URL=postgresql://user:pass@localhost:5432/gas_fee_estimator
