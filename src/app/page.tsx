...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold">Gas Fee Estimator</h1>
        <p className="text-[var(--muted)] mt-1">Multi-chain gas prediction engine using historical data and mempool analysis</p>
      </div>
