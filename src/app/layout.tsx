...
import './globals.css'
export const metadata: Metadata = { title: 'Gas Fee Estimator', description: 'Multi-chain gas prediction engine using historical data and mempool analysis' }
      ...
      <nav className="border-b border-[var(--border)] bg-[var(--surface)] sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold">Gas Fee Estimator</span>
          </div>
